 ...
 * youtube, megavideo, veoh, vimeo or dailymotion
 * 
 ...
 * @author Daniel Sánchez <sanchez.p.dani@gmail.com>
 */
class Yiitube extends CWidget {
    ...
    /**
     * If no player is specified when calling this widget, it will try to look for the
     * correct player inside the url passed through $v (it only works when the full url
     * is provided, if only the video code is provided, then the player parameter is
     * mandatory, otherwise an exception will be raised
     ...
     * if no player setted, try to look for the player in the url
     * if no url is provided, player parameter is mandatory
     * @return bool
     */
    protected function playerSupport()
    {    
        //Looking for the video player in the url
